...
public class SmoothAgentMovement : MonoBehaviour
{
    ...
    private Vector3[] prePostProcessedLocations = new Vector3[0];
    ...
    private void MoveAgent()
    {
        ...
        Agent.velocity = TargetDirection * Agent.speed * Time.deltaTime;
    ...
    private void DrawAgentPath()
    {
        ...
        Debug.DrawLine(transform.position, PathLocations[PathIndex], Color.yellow);

        for (int i = 0; i < prePostProcessedLocations.Length - 1; i++)
        {
            Debug.DrawLine(prePostProcessedLocations[i], prePostProcessedLocations[i + 1], Color.green);
        }
    }
    ...
    private Vector3[] GetPathLocations(BezierCurve[] Curves)
    {
        ...
        prePostProcessedLocations = pathLocations;
    ...
    private void OnDrawGizmos()
    {
        ...
        for (int i = 0; i < prePostProcessedLocations.Length - 1; i++)
        {
            Gizmos.DrawWireSphere(prePostProcessedLocations[i], 0.3f);
        }
